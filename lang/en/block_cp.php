...
/**
 * Strings for component 'block_cp', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_cp
...
$string['pluginname'] = 'Content Processor';
$string['cp:addinstance'] = 'Add a new Content Processor block';
$string['cp:myaddinstance'] = 'Add a new Content Processor block to Dashboard';
$string['cp'] = 'Content Processor';
$string['startwithcp'] = 'Start creating AI powered content!';
$string['dysfunctional'] = 'Currently dysfunctional';
$string['hideblock'] = 'Hide Content Processor';
$string['togglecheck'] = 'check/uncheck';
